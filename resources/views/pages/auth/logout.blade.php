...
@section('title', 'Logged Out - ' . env('APP_NAME'))
    ...
    <div class="col-md-8 col-lg-6 col-xl-4">
            ...
            <div class="card-body p-4">
                ...
                <div class="text-center w-75 m-auto">
                    <div class="auth-logo">
                        ...
                        <a href="{{ route('login') }}index.html" class="logo logo-light text-center">
                            <span class="logo-lg">
        ...
        <div class="row mt-3">
            <div class="col-12 text-center">
                <p class="text-muted">Back to <a href="{{ route('login') }}" class="text-primary fw-medium ms-1">Sign In</a>
                </p>
            </div> <!-- end col -->
        </div>
        <!-- end row -->
