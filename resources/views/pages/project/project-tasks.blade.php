                                                ...
                                                @foreach ($tasks as $todo)
                                                    @if ($todo->status == 'todo')
                                                        <tr>
                                                            ...
                                                            <td><a
                                                                    href="{{ route('tasks.show', ['task' => $todo->id]) }}?task_name={{ Str::slug($todo->name) }}">{{ $todo->name }}</a>
                                                            </td>
                                                            <td>
                                                                <div>
                                                            ...
                                                            <td>
                                                                @if (\Carbon\Carbon::parse($todo->deadline)->lt(Carbon\Carbon::today()))
                                                                    <span
                                                                        class="badge badge-soft-danger">{{ \Carbon\Carbon::parse($todo->deadline)->locale('en_EN')->isoFormat('DD MMMM YYYY') }}</span>
                                                                @else
                                                                    <span
                                                                        class="badge badge-soft-success">{{ \Carbon\Carbon::parse($todo->deadline)->locale('en_EN')->isoFormat('DD MMMM YYYY') }}</span>
                                                                @endif
                                                            </td>
                                                            <td>
                                                                @php
                                                            ...
                                                            <td>
                                                                <ul class="list-inline table-action m-0">
                                                                    <li class="list-inline-item">
                                                                        <a href="{{ route('tasks.edit', ['task' => $todo->id]) }}"
                                                                        ...
                                                                        <div class="dropdown">
                                                                            ...
                                                                            <div
                                                                                ...
                                                                                <a class="dropdown-item"
                                                                                    href="{{ route('tasks.show', ['task' => $todo->id]) }}?task_name={{ Str::slug($todo->name) }}">View
                                                                                    details</a>
                                                                                <a class="dropdown-item"
                                                                                    href="#">Mark as
                                                                                    completed</a>
